...
const offerings = [
  ...
  { id: '03', title: 'Johtajaläsnäolon kehittäminen', duration: 'Kohdennettu — joustava muoto', desc: 'Kehitä johtajaläsnäolon fyysisiä, attentionaalisia ja verbaalisia ulottuvuuksia. Perustuu ICA III — K3™ (Keho, Fokus, Kieli) — tämä valmennus kohdistuu siihen, miten olet läsnä, hallitset huoneen ja johdat vuorovaikutusta.', outcomes: ['K3™-läsnäoloarkkitehtuuri', 'Suoritus paineessa', 'Vuorovaikutuksen johtaminen'] },
